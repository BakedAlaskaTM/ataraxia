...
<tileset version="1.10" tiledversion="1.10.2" name="Testing Tiles" tilewidth="240" tileheight="240" tilecount="27" columns="0">
 <grid orientation="orthogonal" width="1" height="1"/>
 <tile id="0">
  <image width="16" height="16" source="../assets/Tiles/Testing/BlackSquare.png"/>
 </tile>
 <tile id="1">
  <image width="64" height="64" source="../assets/Tiles/Testing/Statue.png"/>
 </tile>
 <tile id="2">
  <image width="128" height="128" source="../assets/Tiles/Testing/House.png"/>
 </tile>
 <tile id="3">
  <image width="16" height="16" source="../assets/Tiles/Testing/DarkStone.png"/>
 </tile>
 <tile id="4">
  <image width="16" height="16" source="../assets/Tiles/Testing/Dirt.png"/>
 </tile>
 <tile id="5">
  <image width="16" height="16" source="../assets/Tiles/Testing/Grass.png"/>
 </tile>
 <tile id="6">
  <image width="16" height="16" source="../assets/Tiles/Testing/Stone.png"/>
 </tile>
 <tile id="7">
 ...
 <tile id="22">
  <image width="32" height="32" source="../assets/Tiles/Testing/Bush1.png"/>
 </tile>
 <tile id="23">
  <image width="32" height="64" source="../assets/Tiles/Testing/Tree1.png"/>
 </tile>
 <tile id="24">
  <image width="16" height="48" source="../assets/Tiles/Testing/Tree2.png"/>
 </tile>
 <tile id="25">
  <image width="80" height="128" source="../assets/Tiles/Testing/Tree3.png"/>
 </tile>
 <tile id="27">
 ...
 <tile id="29">
  <image width="16" height="16" source="../assets/Tiles/Testing/SpikeStoneDown.png"/>
 </tile>
 <tile id="30">
  <image width="16" height="16" source="../assets/Tiles/Testing/DirtBackground.png"/>
 </tile>
</tileset>
